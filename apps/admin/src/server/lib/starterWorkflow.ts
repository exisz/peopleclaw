...
export const DEFAULT_WORKFLOW = {
  ...
  definition: {
    steps: [
      ...
      { id: 'd3', name: 'AI 图片生成',          type: 'agent', assignee: 'ai.image_generate',       description: '', position: { x: 300,  y: 0 } },
      { id: 'd4', name: 'AI 生成商品描述',      type: 'agent', assignee: 'ai.product_description',  description: '', position: { x: 600,  y: 0 } },
      { id: 'd_skus', name: 'AI SKU与价格生成',  type: 'agent', assignee: 'ai.generate_skus',         description: '', position: { x: 900,  y: 0 } },
      { id: 'd5', name: '更新库存',             type: 'agent', assignee: 'shopify.update_inventory', description: '', position: { x: 1200, y: 0 } },
      { id: 'd6', name: '上架商品到Shopify',    type: 'agent', assignee: 'shopify.list_product',    description: '', position: { x: 1500, y: 0 } },
    ],
    nodes: [
      { id: 'd2', position: { x: 0,    y: 0 } },
      { id: 'd3', position: { x: 300,  y: 0 } },
      { id: 'd4', position: { x: 600,  y: 0 } },
      { id: 'd_skus', position: { x: 900,  y: 0 } },
      { id: 'd5', position: { x: 1200, y: 0 } },
      { id: 'd6', position: { x: 1500, y: 0 } },
    ],
    edges: [
      { source: 'd2', target: 'd3' },
      { source: 'd3', target: 'd4' },
