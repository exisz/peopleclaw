...
export const DEFAULT_WORKFLOW = {
  ...
  definition: {
    steps: [
      { id: 'd2', name: 'AI 标题生成',          type: 'agent', assignee: 'ai.generate_title',       description: '', position: { x: 0,   y: 0 }, requiredFields: ['image_url', 'price'] },
    ...
    nodes: [
      { id: 'd2', position: { x: 0,   y: 0 }, requiredFields: ['image_url', 'price'] },
